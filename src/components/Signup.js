...
function Signup() {
  ...
  const SAIDCheck = (IdNumber, setErrors) => {
    ...
    if (IdNumber.length === 13) {
      ...
      evnum5 = d10 * 2;
      evnum6 = d12 * 2;
      evsum = CalcSumOfString(evnum1.toString()) + CalcSumOfString(evnum2.toString()) + CalcSumOfString(evnum3.toString()) + CalcSumOfString(evnum4.toString()) + CalcSumOfString(evnum5.toString()) + CalcSumOfString(evnum6.toString());
